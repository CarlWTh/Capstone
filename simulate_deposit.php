                    ...
                    if ($result->num_rows === 0) {
                        ...
                        if ($voucher['is_used']) {
                            ...
                            try {
                                ...
                                $resultBottleCount = $stmtBottleCount->get_result();
                                if ($resultBottleCount->num_rows === 1) {
                                    $row = $resultBottleCount->fetch_assoc();
                                    $bottleCount = intval($row['bottle_count']);
                                } else {
                                    $bottleCount = 0;
                                }
        ...
        <div class="container">
            ...
            <?php if (!empty($redeemMessage)): ?>
                <div class="message <?php echo $messageType; ?>">
                    ...
                    <?php if ($messageType == 'success' && isset($_SESSION['session_end_time']) && isset($_SESSION['show_countdown']) && $_SESSION['show_countdown']): ?>
